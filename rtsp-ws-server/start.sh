...
h264_pipeline="videotestsrc pattern=ball ! video/x-raw,width=320,height=240 ! timeoverlay text='H.264' valignment=top halignment=left ! x264enc ! rtph264pay name=pay0 pt=96"
h264_port="8554"
